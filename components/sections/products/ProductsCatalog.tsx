						...
						>
							<Link href={`/products/${product.slug}`} className="group block">
								<article className="border-brand-border-soft bg-brand-paper flex h-full flex-col rounded-[28px] border p-6 shadow-[0_10px_30px_var(--shadow-black-03)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_var(--shadow-black-05)]">
									...
									<h3 className="text-brand-ink mt-5 text-2xl leading-tight font-light capitalize sm:text-[2rem]">
										{product.name}
									</h3>
									...
									<div className="text-brand-copy-soft mt-5 grid gap-2 text-sm">
										<div className="flex items-center justify-between gap-4">
											<span>Format</span>
											<span className="text-brand-copy-ui font-medium">
												{product.format}
											</span>
										</div>
										<div className="flex items-center justify-between gap-4">
									...
									<div className="mt-auto flex items-end justify-between gap-4 pt-7">
										...
										<span className="border-brand-gold bg-brand-gold group-hover:border-brand-gold-hover group-hover:bg-brand-gold-hover inline-flex items-center justify-center rounded-full border px-5 py-3 text-[11px] tracking-[0.24em] text-white uppercase transition duration-300">
											View Details
										</span>
									</div>
								</article>
